 ...
 */
bool io::VTFResDataSource::Frame::LoadFrame(vislib::sys::File *file, unsigned int idx, vislib::Array<SimpleType> &types) {
 ...
 */
void io::VTFResDataSource::Frame::UpdatePartColor(unsigned int type, unsigned int idx, vislib::math::Vector<float,4> color)
{
 ...
 */
const io::VTFResDataSource::Frame *
io::VTFResDataSource::Frame::MakeInterpolationFrame(float alpha,
        const io::VTFResDataSource::Frame &a,
        const io::VTFResDataSource::Frame &b) {
 ...
 */
void io::VTFResDataSource::Frame::parseParticleLine(vislib::StringA &line,
 ...
 */
io::VTFResDataSource::VTFResDataSource(void) : view::AnimDataModule(),
        ...
        datahash(0)
{
    ...
    this->getData.SetCallback("MultiParticleDataCall", "GetData",
        &VTFResDataSource::getDataCallback);
    this->getData.SetCallback("MultiParticleDataCall", "GetExtent",
        &VTFResDataSource::getExtentCallback);
...
io::VTFResDataSource::constructFrame(void) const {
...
void io::VTFResDataSource::loadFrame(view::AnimDataModule::Frame *frame, unsigned int idx) {
	...
	file.Open(this->frameFiles[idx], vislib::sys::File::READ_ONLY, vislib::sys::File::SHARE_READ, vislib::sys::File::OPEN_ONLY);
...
bool io::VTFResDataSource::filenameChanged(param::ParamSlot& slot) {
	...
	getFrameFiles(this->filename.Param<param::FilePathParam>()->Value());
