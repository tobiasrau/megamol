 ...
 */
void io::VTFDataSource::Frame::UpdatePartColor(unsigned int type, unsigned int idx, vislib::math::Vector<float,4> color)
{
 ...
 */
const io::VTFDataSource::Frame *
io::VTFDataSource::Frame::MakeInterpolationFrame(float alpha,
        const io::VTFDataSource::Frame &a,
        const io::VTFDataSource::Frame &b) {
 ...
 */
void io::VTFDataSource::Frame::parseParticleLine(vislib::StringA &line,
 ...
 */
io::VTFDataSource::VTFDataSource(void) : view::AnimDataModule(),
...
io::VTFDataSource::constructFrame(void) const {
 ...
 */
void io::VTFDataSource::loadFrame(view::AnimDataModule::Frame *frame,
        unsigned int idx) {
