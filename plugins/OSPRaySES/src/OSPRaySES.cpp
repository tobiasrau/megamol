	...
	public:
		...
		plugin_instance(void)
			: ::megamol::core::utility::plugins::Plugin200Instance(
				...
				"OSPRaySES", // TODO: Change this!

				/* human-readable plugin description */
				"Describing OSPRaySES (TODO: Change this!)") {
		...
		virtual void registerClasses(void) {
			...
			// like:
			//   this->module_descriptions.RegisterAutoDescription<megamol::OSPRaySES::MyModule1>();
			//   this->module_descriptions.RegisterAutoDescription<megamol::OSPRaySES::MyModule2>();
			//   ...
			//
      this->module_descriptions.RegisterAutoDescription<megamol::ospray::ses::CBTest>();
      ...
      this->module_descriptions.RegisterAutoDescription<megamol::ospray::ses::OSPRayInstancedSESRenderer>();
			...
			// like:
			//   this->call_descriptions.RegisterAutoDescription<megamol::OSPRaySES::MyCall1>();
			//   this->call_descriptions.RegisterAutoDescription<megamol::OSPRaySES::MyCall2>();
			//   ...
			//
 ...
 */
OSPRAYSES_API int mmplgPluginAPIVersion(void) {
