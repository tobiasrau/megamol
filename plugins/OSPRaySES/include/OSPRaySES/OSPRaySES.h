 ...
 */
#ifndef OSPRAYSES_H_INCLUDED
#define OSPRAYSES_H_INCLUDED
...
#ifdef OSPRAYSES_EXPORTS
#define OSPRAYSES_API __declspec(dllexport)
#else
#define OSPRAYSES_API __declspec(dllimport)
#endif
#else /* _WIN32 */
#define OSPRAYSES_API
#endif /* _WIN32 */
 ...
 */
OSPRAYSES_API void mmplgReleasePluginCompatibilityInfo(
 ...
 */
OSPRAYSES_API void mmplgReleasePluginInstance(
