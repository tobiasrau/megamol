 ...
 */
class MEGAMOLCORE_API CallGetTransferFunction_gl : public Call {
public:
     ...
     */
    static const char* ClassName(void) { return "CallGetTransferFunction_gl"; }
    ...
    /** Ctor. */
    CallGetTransferFunction_gl(void);

    /** Dtor. */
    virtual ~CallGetTransferFunction_gl(void);
...
typedef factories::CallAutoDescription<CallGetTransferFunction_gl> CallGetTransferFunction_glDescription;
