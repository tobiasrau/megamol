...
#ifndef MEGAMOLCORE_AddClusterColours_H_INCLUDED
#define MEGAMOLCORE_AddClusterColours_H_INCLUDED
...
namespace moldyn {
     ...
     */
    class AddClusterColours : public Module {
    public:
...
#endif /* MEGAMOLCORE_AddClusterColours_H_INCLUDED */
